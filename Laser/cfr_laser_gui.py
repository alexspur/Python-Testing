...
class CFRLaserGUI:
    ...
    def build_gui(self):
        ...
        cmd_frame.grid(row=3, column=0, columnspan=2, sticky="ew", pady=4)
        ...
        fire_frame.grid(row=4, column=0, columnspan=2, sticky="ew", pady=4)
        ...
        log_frame.grid(row=5, column=0, columnspan=2, sticky="nsew", pady=4)
        ...
        ttk.Label(main, textvariable=self.last_resp_var,
                  foreground="gray").grid(row=6, column=0, columnspan=2, sticky="w")
